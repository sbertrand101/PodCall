...
var Router = function (id, token, secret) {
	...
	var gimlet = "https://api.soundcloud.com/tracks/214926459/" +
		"download?secret_token=s-irZuE&client_id=0f8fdbbaa21a9bd18210986a7dc2d72c";
	...
	var shaneAndFriends = "https://api.soundcloud.com/tracks/214153518/" +
		"download?client_id=02gUJC0hH2ct1EGOcYXQIzRFU91c72Ea";
		...
		catapult.Call.get(client, callId, function (err, call) {
			if (err) {
				...
				var fileUrl = (podcastNum === "+18285524457") ? thisAmericanLife :
											...
											(podcastNum === "+14704430900") ? shaneAndFriends :
